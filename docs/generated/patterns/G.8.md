...
- `G.8` --builds_on--> [Method‑SoS‑LOG — MethodFamily Evidence & Maturity](/generated/patterns/C.23)
- `G.8` --builds_on--> [CAL Authoring: Calculi - Acceptance - Evidence](/generated/patterns/G.4)
- `G.8` --builds_on--> [Evidence Graph & Provenance Ledger](/generated/patterns/G.6)
- `G.8` --builds_on--> [Multi‑Method Dispatcher & MethodFamily Registry](/generated/patterns/G.5)
- `G.8` --builds_on--> [Problem Typing & TaskSignature Assignment (Problem‑CHR)](/generated/patterns/C.22)
- `G.8` --explicit_reference--> [Method‑SoS‑LOG — MethodFamily Evidence & Maturity](/generated/patterns/C.23)
- `G.8` --explicit_reference--> [Problem Typing & TaskSignature Assignment (Problem‑CHR)](/generated/patterns/C.22)
- `G.8` --explicit_reference--> [CAL Authoring: Calculi - Acceptance - Evidence](/generated/patterns/G.4)
- `G.8` --explicit_reference--> [Evidence Graph & Provenance Ledger](/generated/patterns/G.6)
- `G.8` --explicit_reference--> [Multi‑Method Dispatcher & MethodFamily Registry](/generated/patterns/G.5)
- `G.8` --explicit_reference--> [Telemetry-Driven Refresh & Decay Orchestrator](/generated/patterns/G.11)
- `G.8` --explicit_reference--> [SoTA Pack Shipping (pack-boundary owner; SoTA-Pack(Core))](/generated/patterns/G.10)
- `G.8` --explicit_reference--> [Alignment & Bridge across Contexts](/generated/patterns/F.9)
- `G.8` --explicit_reference--> [Cross-Tradition Bridge Calibration Kit (BridgeMatrix → BridgeCards + BCT/Sentinels)](/generated/patterns/G.7)
- `G.8` --explicit_reference--> [Mint or Reuse? (U.Type vs Concept-Set vs Role Description vs Alias)](/generated/patterns/F.8)
- `G.8` --explicit_reference--> [Evidence Graph Referring (C-4)](/generated/patterns/A.10)
- `G.8` --explicit_reference--> [LEX-BUNDLE: Unified Lexical Rules for FPF](/generated/patterns/E.10)
- `G.8` --explicit_reference--> [Notational Independence](/generated/patterns/E.5.2)
- `G.8` --explicit_reference--> [Transduction Graph Architecture (E.TGA)](/generated/patterns/E.18)
- `G.8` --explicit_reference--> [GateProfilization: OperationalGate(profile) (GateFit core)](/generated/patterns/A.21)
- `G.8` --explicit_reference--> [NQD‑CAL — Open‑Ended Search Calculus](/generated/patterns/C.18)
- `G.8` --explicit_reference--> [Explore–Exploit Governor (E/E‑LOG)](/generated/patterns/C.19)
